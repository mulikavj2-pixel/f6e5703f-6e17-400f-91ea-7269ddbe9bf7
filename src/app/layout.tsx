...
export const metadata: Metadata = {
  title: "LFAFO - Unscripted Adventure Travel Show",
  description: "Let's F Around and Find Out. Join us as we travel the world with no plans, no itinerary, and complete spontaneity. Adventure awaits.",
  keywords: "travel show, adventure, unscripted, exploration, documentary",
  openGraph: {
    title: "LFAFO - Unscripted Adventure Travel Show",
    description: "Let's F Around and Find Out. Join us as we travel the world with no plans, no itinerary, and complete spontaneity. Adventure awaits.",
    siteName: "LFAFO",
  ...
  twitter: {
    ...
    title: "LFAFO - Unscripted Adventure Travel Show",
    description: "Let's F Around and Find Out. Adventure awaits."
  }
};
